...
public class UnderwaterSwimmingMovement : MovementType
{
    ...
    {
        Vector3 swim = swimming.cameraMovement.TransformDirection(new Vector3(PlayerInputManager.input.x, 0, PlayerInputManager.input.y)) * 2f;
        swim += Vector3.up * PlayerInputManager.elevate;
